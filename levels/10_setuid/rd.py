...
def _setup_memory_cgroup(container_id, memory, memory_swap):
    ...
    container_mem_cgroup_dir = os.path.join(
        MEMORY_CGROUP_BASEDIR, 'docker-python', container_id)

    # Insert the container to new memory cgroup named 'docker-python/container_id'
...
def contain(command, image_name, image_dir, container_id, container_dir,
    ...
    # Drop privileges if user is set
    if user:
